# AGENTS.md — NeuroLift Technologies auth0-assistant0 Repository Agent Gateway

> **Internal use only.** This is the repository-specific governance gateway for coding agents operating in this repository. This copy is scoped to NeuroLift-Technologies/auth0-assistant0, with project-specific operational context kept in this repository.
...
> **Repo-local note:** Governance docs in this repository are the working copy for NeuroLift-Technologies/auth0-assistant0. Keep references local unless Joshua explicitly asks for an upstream sync.
...
- Repo-local governance context: [NeuroLift-Technologies/auth0-assistant0](https://github.com/NeuroLift-Technologies/auth0-assistant0)
...
All files below live in this repository (`NeuroLift-Technologies/auth0-assistant0`):
