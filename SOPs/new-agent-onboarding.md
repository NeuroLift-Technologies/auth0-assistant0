...
- Ability to read files from `NeuroLift-Technologies/auth0-assistant0` (this repo)
...
Read `NLT-DEV-OTOI.md` in this repository (`NeuroLift-Technologies/auth0-assistant0`):
