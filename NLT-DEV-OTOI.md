# NLT-DEV-OTOI — auth0-assistant0 Developer Operations & Team Orientation Index

**Document ID:** ORG-DEV-OTOI-1.0.0  
**Scope:** Repository-specific (NeuroLift-Technologies/auth0-assistant0)  
**Repository:** `NeuroLift-Technologies/auth0-assistant0`  
